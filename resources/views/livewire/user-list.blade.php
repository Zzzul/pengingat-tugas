                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" id="username"
                                    ...
                                    wire:model="username" aria-describedby="username" disabled
                            ...
                            <div class="col-md-10 col-sm-12">
                                ...
                                <label class="form-check-label" style="cursor : pointer;">
                                    <input class="form-check-input" type="checkbox" value="{{ $permis->id }}"
                                        id="permis-{{ $permis->id }}" wire:model="permissions.id.{{ $loop->index }}"
                                        checked>
                                    {{ ucfirst($permis->name) }}
                                </label>
                                @endforeach
                                ...
                                <label class="form-check-label" style="cursor : pointer;">
                                    <input class="form-check-input" type="checkbox" id="permis-{{ $not_permis->id }}"
                                        value="{{ $not_permis->id }}"
